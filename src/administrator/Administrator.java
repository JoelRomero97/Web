...
public class Administrator extends HttpServlet
{
	...
	throws ServletException, IOException
	{
		...
		out.println("<a href='AddUserForm.html' class='w3-bar-item w3-button w3-hover-sand' id='links_barra'><i class='material-icons'>&#xe148;</i>Add User</a>");
		out.println("<a href='Select?Action=Edit' class='w3-bar-item w3-button w3-hover-pale-yellow' id='links_barra'><i class='material-icons'>&#xe150;</i>Edit User</a>");
