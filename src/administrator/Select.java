...
public class Select extends HttpServlet
{
	...
	public void show_html(String button_type, String mensaje, String boton, HttpServletResponse response) throws IOException
	{
		...
		out.println("<a href='http://localhost:8088/Proyecto/Administrator' class='w3-bar-item w3-button w3-hover-sand' id='links_barra'><i class='material-icons'>&#xe88a;</i>Home</a>");
		out.println("<a href='http://localhost:8088/Proyecto/AddUserForm.html' class='w3-bar-item w3-button w3-hover-pale-yellow' id='links_barra'><i class='material-icons'>&#xe148;</i>Add User</a>");
		...
		{
			out.println("<a href='http://localhost:8088/Proyecto/Select?Action=Edit' class='w3-bar-item w3-button w3-hover-sand' id='links_barra'><i class='material-icons'>&#xe150;</i>Edit User</a>");
			out.println("<a href='#' class='w3-bar-item w3-button w3-camo-gray w3-hover-blue-gray' id='links_barra'><i class='material-icons'>&#xe16c;</i>Delete User</a>");
		}
